...
namespace SDHK
{
    ...
    public abstract class EventActionSystem<T1, T2> : SystemBase<Action<T1, T2>, IEventSystem>, IEventSystem
    {
        public Delegate GetDeleate() => (Action<T1, T2>)Event;
        public abstract void Event(T1 arg1, T2 arg2);
    }
    public abstract class EventActionSystem<T1, T2, T3> : SystemBase<Action<T1, T2, T3>, IEventSystem>, IEventSystem
    {
        public Delegate GetDeleate() => (Action<T1, T2, T3>)Event ;
        public abstract void Event(T1 arg1, T2 arg2, T3 arg3);
    }

    public abstract class EventActionSystem<T1, T2, T3, T4> : SystemBase<Action<T1, T2, T3, T4>, IEventSystem>, IEventSystem
    {
        public Delegate GetDeleate() => (Action<T1, T2, T3, T4>)Event;
        public abstract void Event(T1 arg1, T2 arg2, T3 arg3, T4 arg4);
    }

    public abstract class EventActionSystem<T1, T2, T3, T4, T5> : SystemBase<Action<T1, T2, T3, T4, T5>, IEventSystem>, IEventSystem
    {
    ...
    public abstract class EventFuncSystem<OutT> : SystemBase<Func<OutT>, IEventSystem>, IEventSystem
    {
        public Delegate GetDeleate() => (Func<OutT>)Event;
        public abstract OutT Event();
    }

    public abstract class EventFuncSystem<T1, OutT> : SystemBase<Func<T1, OutT>, IEventSystem>, IEventSystem
    {
    ...
    public abstract class EventFuncSystem<T1, T2, OutT> : SystemBase<Func<T1, T2, OutT>, IEventSystem>, IEventSystem
    {
        public Delegate GetDeleate() => (Func<T1, T2, OutT>)Event;
        public abstract OutT Event(T1 arg1, T2 arg2);
    }

    public abstract class EventFuncSystem<T1, T2, T3, OutT> : SystemBase<Func<T1, T2, T3, OutT>, IEventSystem>, IEventSystem
    {
        public Delegate GetDeleate() => (Func<T1, T2, T3, OutT>)Event;
        public abstract OutT Event(T1 arg1, T2 arg2, T3 arg3);
    }

    public abstract class EventFuncSystem<T1, T2, T3, T4, OutT> : SystemBase<Func<T1, T2, T3, T4, OutT>, IEventSystem>, IEventSystem
    {
        public Delegate GetDeleate() => (Func<T1, T2, T3, T4, OutT>)Event;
        public abstract OutT Event(T1 arg1, T2 arg2, T3 arg3, T4 arg4);
    }

    public abstract class EventFuncSystem<T1, T2, T3, T4, T5, OutT> : SystemBase<Func<T1, T2, T3, T4, T5, OutT>, IEventSystem>, IEventSystem
    {
