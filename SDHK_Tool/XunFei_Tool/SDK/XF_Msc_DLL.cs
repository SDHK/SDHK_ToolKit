...
namespace XunFei_Tool
{
    ...
    public enum ErrorCode
    {
        ...
        MSP_ERROR_INVALID_HANDLE = 10108,   /* 0x277C */ /* MSP错误无效句柄 */
    ...
    public class XF_Msc_DLL
    {
        ...
        /// 初始化msc，用户登录。
        /// </summary>
        /// <param name="usr">为Null即可</param>
        /// <param name="pwd">为Null即可</param>
        /// <param name="parameters">通常为："appid = 123456" ，如果有多个参数对，再用逗号进行拼接</param>
        ...
        /// 退出登录
        /// </summary>
        /// <returns>调用成功返回MSP_SUCCESS，否则返回错误代码</returns>
        ...
        /// 开始一次语音合成，分配语音合成资源。
        /// </summary>
        /// <param name="_params">语音合成参数，去官网查看参数文档</param>
        /// <param name="errorCode">错误码</param>
        /// <returns>会话权柄</returns>
        [DllImport("msc_x64", CallingConvention = CallingConvention.Winapi)]
        ...
        /// 写入要合成的文本。
        /// </summary>
        /// <param name="sessionID">会话权柄</param>
        /// <param name="textString">要合成的文本</param>
        /// <param name="textLen">文本的二进制长度，最大支持8192个字节</param>
        /// <param name="_params">本次合成所用的参数，只对本次合成的文本有效。</param>
        /// <returns>返回错误码</returns>
        [DllImport("msc_x64", CallingConvention = CallingConvention.Winapi)]
        ...
        /// 开始一次语音识别
        /// </summary>
        /// <param name="grammarList">语法列表：可以为Null</param>
        /// <param name="_params">识别参数</param>//http://mscdoc.xfyun.cn/windows/api/iFlytekMSCReferenceManual/qisr_8h.html#aaec4a5779275e07c4f7405ed8d739416
        /// <param name="errorCode">错误代码</param>
        /// <returns>函数调用成功返回字符串格式的sessionID，失败返回NULL。sessionID是本次识别的句柄</returns>
        [DllImport("msc_x64", CallingConvention = CallingConvention.Winapi)]
        ...
        /// <param name="epStatus">端点检测器所处的状态</param>//EpStatus类
        /// <param name="rsltStatus">识别器返回的状态</param>//RsltStatus类
        /// <returns></returns>
        [DllImport("msc_x64", CallingConvention = CallingConvention.Winapi)]
        ...
        /// <param name="errorCode">错误代码</param>
        /// <returns>返回结果字符串指针；其他情况(失败或无结果)返回NULL</returns>
        [DllImport("msc_x64", CallingConvention = CallingConvention.Winapi)]
