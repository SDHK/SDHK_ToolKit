...
{
    public static RectTransform SE_GetRect(this Transform transform)
    {
    ...
    {
        if (space == Space.World)
            transform.eulerAngles = SS_Rotation.EulerAngles_MoveTowards(transform.eulerAngles, TargetEulerAngle, RotatingMoveSpeed);
        else
            transform.localEulerAngles = SS_Rotation.EulerAngles_MoveTowards(transform.localEulerAngles, TargetEulerAngle, RotatingMoveSpeed);
    }
    ...
    {
        if (space == Space.World)
            transform.eulerAngles = SS_Rotation.EulerAngles_Lerp(transform.eulerAngles, TargetEulerAngle, RotatingMoveSpeed);
        else
            transform.localEulerAngles = SS_Rotation.EulerAngles_Lerp(transform.localEulerAngles, TargetEulerAngle, RotatingMoveSpeed);
    }
    ...
    public static Vector3 SE_EulerAngles_SmoothDamp(this Transform transform, Vector3 TargetEulerAngle, float MoveTime, Space space = Space.World)
    {
        ...
        if (space == Space.World)
            transform.eulerAngles = SS_Rotation.EulerAngles_SmoothDamp(transform.eulerAngles, TargetEulerAngle, ref yVelocity, MoveTime);
        else
            transform.localEulerAngles = SS_Rotation.EulerAngles_SmoothDamp(transform.localEulerAngles, TargetEulerAngle, ref yVelocity, MoveTime);
    ...
    {
        if (space == Space.World)
            transform.position = SS_Mathf.Clamp_Vector3(transform.position, Limit_Min, Limit_Max, Limit_X, Limit_Y, Limit_Z);
        else
            transform.localPosition = SS_Mathf.Clamp_Vector3(transform.localPosition, Limit_Min, Limit_Max, Limit_X, Limit_Y, Limit_Z);
    }
    ...
    {
        if (space == Space.World)
            transform.position = SS_Mathf.Clamp_Vector3_Scope(transform.position, TargetPoint, Limit_Radius);
        else
            transform.localPosition = SS_Mathf.Clamp_Vector3_Scope(transform.localPosition, TargetPoint, Limit_Radius);
    }
    ...
    {
        if (space == Space.World)
            transform.eulerAngles = SS_Mathf.Clamp_EulerAngle(transform.eulerAngles, Limit_Min, Limit_Max, Limit_X, Limit_Y, Limit_Z);
        else
            transform.localEulerAngles = SS_Mathf.Clamp_EulerAngle(transform.localEulerAngles, Limit_Min, Limit_Max, Limit_X, Limit_Y, Limit_Z);
    }
    ...
    {
        transform.localScale = SS_Mathf.Clamp_Vector3(transform.localScale, Limit_Min, Limit_Max, Limit_X, Limit_Y, Limit_Z);
    }
